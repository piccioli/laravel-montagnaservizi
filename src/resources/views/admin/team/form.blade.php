...
@section('title', $member ? 'Modifica membro team' : 'Nuovo membro team')

@section('content')
<form method="POST"
      action="{{ $member ? route('admin.team.update', $member->id) : route('admin.team.store') }}"
    ...
    <div class="ms-field-row">
        ...
        <div class="ms-field">
            <label for="role">Ruolo <span style="color:#dc2626">*</span></label>
    ...
    <div class="ms-field">
        ...
        <textarea id="bio" name="bio" style="min-height:120px;">{{ old('bio', $member?->bio) }}</textarea>
    </div>
    ...
    <div class="ms-field">
        ...
        @if($member?->photo)
            <p style="margin-bottom:.5rem;">
                <img src="{{ Storage::url($member->photo) }}" alt="" style="height:72px;width:72px;border-radius:50%;object-fit:cover;">
            </p>
        @endif
    ...
    <div style="display:flex;gap:1rem;margin-top:1.5rem;">
        ...
        <a href="{{ route('admin.team.index') }}" class="ms-btn ms-btn--outline">Annulla</a>
    </div>
</form>
@endsection
